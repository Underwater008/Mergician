...
template<> HEROESBUILDERPLUGIN_API UScriptStruct* StaticStruct<FHeroesBuilder_GridTileInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_TBD_Plugins_HeroesBuilderPlugin_Source_HeroesBuilderPlugin_Public_HeroesBuilder_GridTile_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TBD_Plugins_HeroesBuilderPlugin_Source_HeroesBuilderPlugin_Public_HeroesBuilder_GridTile_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TBD_Plugins_HeroesBuilderPlugin_Source_HeroesBuilderPlugin_Public_HeroesBuilder_GridTile_h_1054105736(TEXT("/Script/HeroesBuilderPlugin"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_TBD_Plugins_HeroesBuilderPlugin_Source_HeroesBuilderPlugin_Public_HeroesBuilder_GridTile_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TBD_Plugins_HeroesBuilderPlugin_Source_HeroesBuilderPlugin_Public_HeroesBuilder_GridTile_h_Statics::ScriptStructInfo),
		nullptr, 0);
